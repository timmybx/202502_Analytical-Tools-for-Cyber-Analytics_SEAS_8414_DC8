...
def _row_for_profile(
    ...
    if profile == "state":
        ...
        f["URL_Length"] = _tri_choice(rng, 0.10, 0.20, 0.70)
...
def generate_synthetic_dataset(
    ...
    df = df[ALL_FEATURES + ["threat_profile", "label"]]
    return df
...
def main() -> None:
    ...
    _ = cls_setup(
        ...
        session_id=42,
        verbose=False,
        ignore_features=["threat_profile"],  # don't ignore has_political_keyword
    )
    ...
    _ = pcl.setup(data=cluster_df, session_id=42, verbose=False, preprocess=True)
